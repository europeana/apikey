...
public class ApikeyControllerTest {
    ...
    public void validateExistingApikey() throws Exception {
        Optional<Apikey> optionalExistingApikey = apikeyRepo.findOne(Example.of(new Apikey(EXISTING_API_KEY)));
    ...
    public void validateDeprecatedApikey() throws Exception {
        Optional<Apikey> optionalDeprecatedApikey = apikeyRepo.findOne(Example.of(new Apikey(DEPRECATED_API_KEY)));
